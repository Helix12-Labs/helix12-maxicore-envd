module github.com/Helix12-Labs/helix12-maxicore-envd/packages/envd

go 1.25.9

replace github.com/Helix12-Labs/helix12-maxicore-envd/packages/shared v0.0.0 => ../shared
...
require (
	...
	github.com/Helix12-Labs/helix12-maxicore-envd/packages/shared v0.0.0
